...
const inputBaseStyles = clx(
  "caret-ui-fg-base bg-ui-custom-bg placeholder-ui-fg-muted text-ui-fg-base transition-fg relative w-full border border-ui-custom-border appearance-none rounded-md outline-none",
